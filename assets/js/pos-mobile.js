(function () {
  ...
  window.openMobileDetailPanel = function (panelId) {
    var panel = document.getElementById(panelId) || document.querySelector(".detail-panel");
    if (panel) {
  ...
  function ensureBottomNav() {
    ...
    var items = [
      { href: "dashboard.html", label: "Home", match: ["dashboard.html", "store-dashboard.html", "admin-dashboard.html"], svg: icon('<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline>') },
      { href: "orders.html", label: "Orders", match: ["orders.html", "pos-orders.html", "pos.html"], svg: icon('<rect x="1" y="4" width="22" height="16" rx="2"></rect><line x1="1" y1="10" x2="23" y2="10"></line>') },
      { href: "inventory.html", label: "Stock", match: ["inventory.html"], svg: icon('<path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path>') },
      { href: "profit-loss.html", label: "P&L", match: ["profit-loss.html", "statistics.html", "statistic.html", "reports.html", "expenses.html"], svg: icon('<line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path>') },
      { href: "index.html", label: "Store", match: ["index.html"], svg: icon('<circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line>') }
    ];
